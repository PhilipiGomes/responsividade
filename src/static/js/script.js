document.addEventListener('DOMContentLoaded', function() {
  ...
  if (saibaMaisBtn) {
    saibaMaisBtn.addEventListener('click', function() {
      showNotification('O aquafloww é um sistema de controle de irrigação inteligente que utiliza múltiplos parâmetros para otimizar o uso de água.', 'info');
    });
  }
  ...
  console.log('✅ aquafloww JavaScript carregado com sucesso!');
});
